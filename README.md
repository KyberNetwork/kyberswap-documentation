...
Currently deployed on 14 chains, including Ethereum, Polygon, BNB Chain, Avalanche, Fantom, Cronos, Arbitrum, BitTorrent, Velas, Aurora, Oasis, Optimism, and Solana. KyberSwap aggregates liquidity from over 80 DEXs and multiple Aggregators to give users the best rates possible for their swaps.
