...
**KyberSwap** is a multi-chain decentralized solution developed within the Kyber Network Ecosystem, offering advanced trading tools and a comprehensive suite of earning opportunities across EVM blockchain networks. Built on [decentralized finance](https://docs.kyberswap.com/getting-started/foundational-topics/decentralized-finance) (DeFi) principles of open access, KyberSwap serves human users through the interface, builders and developers through open APIs, and AI agents through pre-built skills and an MCP server.

Through the KyberSwap Interface, users can access a full suite of on-chain trading tools — swap, limit order, cross-chain swap — alongside Kyber Earn, a hub to explore and manage earning opportunities. Through the KyberSwap Public APIs, developers and builders can integrate decentralized trading and liquidity tools into their own dApps. KyberSwap also provides pre-built skills and an MCP server for developers and AI agents to interact with KyberSwap's on-chain infrastructure for data queries, automated trading, and liquidity provision.

KyberSwap connects to over [420+ liquidity sources across 19 chains](https://docs.kyberswap.com/getting-started/supported-exchanges-and-networks), serving as DeFi's open and permissionless liquidity backbone. With hundreds of projects building on top of KyberSwap, our solutions have facilitated over US$170B in transactions for more than 4.8M users, consistently ranking #1 on EVM by trading volume.
...
The KyberSwap Services comprise the **KyberSwap Interface** and the **KyberSwap Public APIs**. Both are made available on an open and permissionless basis: no account, API key, or commercial agreement is required to use them.
...
* [**Cross-chain Swap**](https://docs.kyberswap.com/user-guide/cross-chain-swap): Enables users to transfer and exchange assets across [22 supported blockchain networks](getting-started/supported-exchanges-and-networks.md), including non-EVM and EVM chains. KyberSwap aggregates quotes from multiple third-party cross-chain providers, automatically selecting the best rate while giving users full transparency to compare routes, fees, and estimated arrival times.
...
### KyberSwap Public APIs

KyberSwap Public APIs let developers and builders integrate KyberSwap's trading and liquidity tools into their own dApps. They are openly accessible and permissionless. Refer to [Start Here](developer-guide/start-here/) for prerequisites, rate limits, and supported chains.

* [**KyberSwap Aggregator**](https://docs.kyberswap.com/developer-guide/aggregator-api): The engine behind KyberSwap's swap functionality. Connected to over 420+ liquidity sources across 19 chains, the Aggregator [splits and reroutes trades](https://docs.kyberswap.com/developer-guide/start-here/foundational-solutions/dynamic-trade-routing) through capital-efficient sources, ensuring optimal swap rates while encouraging greater market stability. Swaps are further enhanced by [Smart Settlement](developer-guide/start-here/foundational-solutions/smart-settlement-better-swap-output-with-lower-slippage.md), which compares candidate pools on-chain at execution time to maximize token output, minimize slippage, and protect against manipulation.
...
* [**AI Agent Hub**](ai-agent-hub/overview.md): Resources and tools that enable AI agents to interact with KyberSwap Public APIs for trading, managing liquidity, and querying DeFi data across 18 EVM chains. Includes [Skills](ai-agent-hub/skills-for-local-agents.md) (pre-built markdown instructions for local AI coding agents using `curl` and `cast`) and an [MCP Server](ai-agent-hub/mcp-server-for-hosted-agents.md) for hosted agents.

## KyberSwap Integration

Integrations that go beyond public, permissionless access require a separate written commercial or partnership agreement with KyberSwap. These arrangements are governed by the terms of that agreement, which will be provided as part of the engagement.

To discuss a commercial integration, contact our team via [business@kyber.network](mailto:business@kyber.network).
