...
KyberSwap Public APIs let developers and builders integrate KyberSwap's trading and liquidity tools into their own dApps. They are open and do not require authentication. Refer to [Start Here](developer-guide/start-here/) for prerequisites, rate limits, and supported chains.
