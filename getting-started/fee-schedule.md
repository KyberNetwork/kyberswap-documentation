...
2.  **Fee Summary Table**<br>
    ...
    \
    \* For Swap (KyberSwap Aggregator), we do not charge a protocol fee. However, positive slippage is applied to certain trades. For more information, please refer to [KyberSwap positive slippage surplus collection](../developer-guide/aggregator-api/aggregator-api-specification/evm-swaps.md#kyberswap-positive-slippage-surplus-collection).
