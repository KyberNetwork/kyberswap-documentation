...
For guides on how to integrate the KyberSwap Widget into your app, you can refer to [Integrating The KyberSwap Widget](integrating-the-kyberswap-widget.md).
...
You can [customize](customizing-the-kyberswap-widget.md) the colors, font, and token list to match your app theme.. Alternatively, you can use our slightly modified sample `theme` to create your own look and feel.
...
* [Monetize your integration with custom fee](widget-iframe-fee.md)
