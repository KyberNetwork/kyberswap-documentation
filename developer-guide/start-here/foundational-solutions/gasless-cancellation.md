...
* **Operator signature**: Valid for 60-90 seconds and is only created when an operator unsigned maker order is included in a quote (via [LO Taker](../../../kyberswap-solutions/limit-order/limit-order-api-specification/taker-apis.md) or [Aggregator](../../aggregator-api/aggregator-api-specification/evm-swaps.md) APIs).
