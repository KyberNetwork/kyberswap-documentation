...
### INTRODUCTION[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#introduction) <a href="#introduction" id="introduction"></a>
...
### INDEX[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#index) <a href="#index" id="index"></a>

\<AUTOGENERATED\_TABLE\_OF\_CONTENTS>

### REFERENCE[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#reference) <a href="#reference" id="reference"></a>

#### Endpoints[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#endpoints) <a href="#endpoints" id="endpoints"></a>

#### `/buy_rate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#buy_rate) <a href="#buy_rate" id="buy_rate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example)
...
#### `/change24h`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#change24h) <a href="#change24h" id="change24h"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-1)
...
#### `/currencies`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#currencies) <a href="#currencies" id="currencies"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-2)
...
#### `/expectedRate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#expectedrate) <a href="#expectedrate" id="expectedrate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-3)
...
#### `/gas_limit`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#gas_limit) <a href="#gas_limit" id="gas_limit"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-4)
...
#### `/gasLimitConfig`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#gaslimitconfig) <a href="#gaslimitconfig" id="gaslimitconfig"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-5)
...
#### `/hint`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#hint) <a href="#hint" id="hint"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-6)
...
#### `/market`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#market) <a href="#market" id="market"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-7)
...
#### `/quote_amount`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#quote_amount) <a href="#quote_amount" id="quote_amount"></a>
...
**Examples**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#examples)
...
#### `/all_reserves`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#all_reserves) <a href="#all_reserves" id="all_reserves"></a>
...
**Reserve Types**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#reserve-types)
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-8)
...
#### `/reserves`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#reserves) <a href="#reserves" id="reserves"></a>
...
**Reserve Types**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#reserve-types-1)
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-9)
...
#### `/sell_rate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#sell_rate) <a href="#sell_rate" id="sell_rate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-10)
...
#### `/trade_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#trade_data) <a href="#trade_data" id="trade_data"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-11)
...
#### `/transfer_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#transfer_data) <a href="#transfer_data" id="transfer_data"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-12)
...
#### `/users/:user_address/currencies`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#usersuser_addresscurrencies) <a href="#usersuser_addresscurrencies" id="usersuser_addresscurrencies"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-13)
...
#### `/users/:user_address/currencies/:currency_id/enable_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#usersuser_addresscurrenciescurrency_idenable_data) <a href="#usersuser_addresscurrenciescurrency_idenable_data" id="usersuser_addresscurrenciescurrency_idenable_data"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api_abi-restfulapi#example-14)
