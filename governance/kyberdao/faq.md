...
If you have KNC tokens on other networks, these will first need to be [bridged to Ethereum](https://github.com/KyberNetwork/kyberswap-documentation/blob/main/governance/kyberdao/broken-reference/README.md) before they can be used to participate in KyberDAO.
