...
{% file src="../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml" %}
...
{% swagger src="../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml" path="/{chain}/api/v1/routes" method="get" %}
[KyberSwapAggregator_EVMAPIs_v2.8.0.yaml](../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml)
{% endswagger %}

{% swagger src="../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml" path="/{chain}/api/v1/route/build" method="post" %}
[KyberSwapAggregator_EVMAPIs_v2.8.0.yaml](../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml)
{% endswagger %}

### `Legacy`

{% swagger src="../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml" path="/{chain}/route/encode" method="get" %}
[KyberSwapAggregator_EVMAPIs_v2.8.0.yaml](../../../.gitbook/assets/KyberSwapAggregator_EVMAPIs_v2.8.0.yaml)
{% endswagger %}
